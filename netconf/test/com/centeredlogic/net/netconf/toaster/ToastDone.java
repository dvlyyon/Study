 ...
 */
package com.centeredlogic.net.netconf.toaster;
...
public class ToastDone
{
   ...
   /**
    * Creates a default ToastDone instance.
    */
   public ToastDone()
   {
   }
   ...
   /**
    * Returns the value of the toastStatus.
    *
    * @return  The current value of toastStatus.
    */
   public java.lang.String getToastStatus()
   {
      return toastStatus;
   }

   /**
    * Sets toastStatus to the specified value.
    *
    * @param x  The new value of toastStatus.
    */
   public void setToastStatus(java.lang.String p_toastStatus)
   {
      toastStatus = p_toastStatus;
   }
