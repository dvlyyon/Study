 ...
 */
package com.centeredlogic.net.netconf.marshalling;
...
public class MarshalTest extends TestCase
{
   ...
   public static void main(String[] args)
   {
      try
      {
         ...
         if ("read".equals(op))
         {
            Element rpcReply = com.centeredlogic.util.XmlUtils.fromXmlFile(cmdline.getArgument("file"));
         ...
         else // if op = write
         {
            ...
            System.out.println(com.centeredlogic.util.XmlUtils.toXmlString(objectRoot));
         }
      }
