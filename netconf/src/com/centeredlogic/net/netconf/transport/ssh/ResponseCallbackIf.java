...
/**
 * The ResponseCallbackIf interface defines the API that is invoked when a message is received from a device over an SSH connection.
 *
 * @author  Subramaniam Aiylam
 * @since   1.6
 */
public interface ResponseCallbackIf
{

   /**
    * Called when an SSH response is received.
    *
    * @param response   NETCONF XML representing the response over an SSH connection.
    */
   void processResponse(final Element response);
